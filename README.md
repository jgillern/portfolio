...
- heslo k PDF uložené per účet odděleně v secret manageru / OS keychainu;
...
5. elektronické potvrzení/PDF z WebTraderu a kvartální výpis se použijí pro backfill a reconciliaci.
...
Lokální Playwright agent se tím přesouvá z kritické cesty do volitelného fallbacku pro historické reporty, chybějící typy událostí nebo automatické stažení kontrolního PDF. Pokud bude použit, běží pouze na důvěryhodném zařízení, neobchází MFA, neukládá brokerské heslo do aplikace a nikdy neotevírá obrazovky pro zadání obchodního pokynu.
...
| Local agent | volitelný Patria fallback pro reporty a případně lokální Gmail režim |
...
- brokerské přihlašovací údaje zůstávají lokálně; běžné Patria e-mailové importy je nepotřebují;
...
- volitelný lokální Patria agent nebo připravený ruční fallback pro kontrolní reporty;
...
- přesný způsob bezpečného uložení a rotace hesla k XTB PDF pro každý účet;
